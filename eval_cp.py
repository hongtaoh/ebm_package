...
# data_dir = "data"
# temp_results_dir = "temp_json_results/conjugate_priors"  # Folder for temp results
# img_dir = 'img/conjugate_priors'
...
if __name__ == "__main__":
    ...
    accepted_order_dicts = conjugate_priors_alg.metropolis_hastings_with_conjugate_priors(
        data_we_have,
        iterations,
        n_shuffle,
    )
