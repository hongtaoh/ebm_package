...
if __name__ == "__main__":
    # # not_available_fnames is initially all the dataset names
    ...
    # ]
    # # if there is not_available_fnames_file
    # # then update:
    # if os.path.exists(not_available_fnames_file):
    #     with open(not_available_fnames_file, 'r') as f: 
    #         not_available_fnames = [l.strip() for l in f]
